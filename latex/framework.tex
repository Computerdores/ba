\section{Framework}
\todo{is this the right amount of detail?}
\subsection{Goals}
\todo{not sure about this subsection title, ``Requirements'' maybe?}
\begin{itemize}
    \item framework for benchmarking different SPSC FIFO queues in different benchmarks
...
\begin{itemize}
    ...
    \item incremented at constant rate of CPU base frequency if CPU has invariant TSC (The CPU I use does)
