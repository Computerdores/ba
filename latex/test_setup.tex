...
\subsubsection{Basic/Bursty 65k-2k}
\begin{itemize}
    \item same as the Basic/Bursty 65k-16k, but burst size is 2k instead of 16k
    \item EQueue tested this (with bursty) as well, showed negligible difference between queues
\end{itemize}


\todo{consider adding more benchmarks}
