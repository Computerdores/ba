...
operation time being larger than \ns{50}\cite{EQueue}.}.
...
The minimum and maximum sizes of EQueue are set to $256$ and $65,536$, respectively,
...
Lastly, the \texttt{wait\_time} parameter was set to \ns{358} in accordance with the
